...
$heading = get_field('section_video_heading') ?: 'Two Minutes of Her in a <em class="text-gold italic">Room.</em>';
$text = get_field('section_video_text') ?: "A glimpse into Joanna's presence, storytelling, and emotional leadership in live speaking environments.";
$video_url = get_field('section_video_video_url');
?>
        ...
        <div class="mt-12 max-w-3xl mx-auto">
            ...
            <?php else: ?>
                <div class="relative aspect-video rounded-lg overflow-hidden bg-gray-600">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/speaker-bg.webp" alt="Joanna speaking" class="w-full h-full object-cover">
