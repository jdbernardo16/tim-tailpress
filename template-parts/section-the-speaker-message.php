...
/**
 * The Speaker Page - Message Section template part.
 *
 * @package TailPress
 */

$heading = get_field('section_message_heading') ?: 'You <em class="text-gold italic">Don&rsquo;t Need</em> to Sound More Impressive.';

$default_text = <<<HTML
<p>You need to understand:</p>
<ul>
  <li>what shaped you</li>
  <li>what people emotionally connect to</li>
  <li>and why your story actually matters</li>
</ul>
<p>That&rsquo;s where this work begins.</p>
HTML;
