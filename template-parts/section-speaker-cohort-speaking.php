...
$heading = get_field('section_speaking_heading') ?: 'This is <em class="font-normal text-gold italic">Not</em> Just<br>Speaking Training.';
$text = get_field('section_speaking_text');
?>
