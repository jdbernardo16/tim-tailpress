...
/**
 * The Authority Page - Message Section template part.
 *
 * @package TailPress
 */
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
            ...
            <div class="w-full lg:w-1/2 flex justify-center lg:justify-start">
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/the-authority.webp" alt="Joanna Horton McPherson" class="w-full max-w-lg object-cover rounded-xl">
            </div>
