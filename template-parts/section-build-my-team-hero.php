...
$heading = get_field('section_hero_heading') ?: 'Build Leaders.<br><em class="text-gold italic">Not Just Results.</em>';
$subtitle = get_field('section_hero_subtitle') ?: 'Build My Team is Joanna&rsquo;s private leadership experience for founders and executives ready to scale trust, communication, and leadership across an entire organization. This is where your message becomes a system others can lead through.';
