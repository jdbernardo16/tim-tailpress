...
/**
 * The Legacy Page - Two Ways Forward Section template part.
 *
 * @package TailPress
 */

$heading = get_field('section_two_ways_heading') ?: "Two Ways <em>Forward</em>";

$offers = array(
    array(
        'title'       => 'Build My Team<br>— My Scaling Strategy',
        'description' => 'Your message becomes a system.',
        'includes'    => array(
    ...
    array(
        'title'       => 'Be Remembered<br>— My Legacy Framework',
        'description' => 'Your work outlives you.',
        'includes'    => array(
