...
$bullets = array(
    ...
    'The next step that actually moves you forward',
);
?>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative bg-navy rounded-3xl overflow-hidden">
            ...
            <div class="absolute top-6 left-0 right-0 flex justify-center pointer-events-none">
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/breakthrough-text.webp" alt="" aria-hidden="true" class="h-20 md:h-24 opacity-20 object-contain">
            </div>
