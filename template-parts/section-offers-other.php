...
$heading = get_field('section_other_heading') ?: 'Other Ways to<br>Work <em class="text-gold italic">Together</em>';
?>
<section class="bg-canvas pb-24 lg:pb-32">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mt-12 max-w-3xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-2">
            <?php if (have_rows('section_other_items')): ?>
                <?php while (have_rows('section_other_items')): the_row(); ?>
                    <div class="bg-warm-beige rounded-[10px] border border-gold-section p-6 sm:p-8 flex flex-col">
                        ...
                        <p class="mt-8 font-flatline font-medium text-4xl text-gold leading-[1.1]">
                            <?= esc_html(get_sub_field('item_price')) ?>
                        </p>
            ...
            <?php else: ?>
                ...
                $other_offers = array(
                    ...
                    array(
                        ...
                        'url'         => home_url('/breakthrough-sessoin/'),
                    ),
                );
                ?>
