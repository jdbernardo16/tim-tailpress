...
<section class="relative mx-10 rounded-3xl overflow-hidden bg-navy">
    <!-- Background image -->
    <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" style="background-image: url('<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/speaker-bg.png');"></div>

    <!-- Speaker Cohort gradient text watermark -->
    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/speaker-cohort.png"
        alt="SPEAKER COHORT"
        class="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-[1360px] pointer-events-none select-none z-1"
        aria-hidden="true">

    <div class="relative flex items-center justify-between max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-[564px]">
        <!-- Left image -->
        <div class="flex-1 flex justify-start items-end h-full">
            <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/joana-speaker.png"
