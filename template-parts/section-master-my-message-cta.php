...
/**
 * Master My Message Page - Pricing CTA Section template part.
 *
 * @package TailPress
 */
?>
        ...
        <div class="relative bg-warm-beige rounded-3xl overflow-hidden">
            ...
            <div class="relative px-6 py-20 md:px-12 md:py-24 lg:px-20 flex flex-col items-center text-center">
                ...
                <h2 class="font-flatline font-medium text-4xl md:text-5xl lg:text-[56px] text-navy leading-[1.1] max-w-[620px]">
                    Some People Have <em class="font-normal">Expertise</em>. <em class="text-gold italic">Others Become Known For it.</em>
                </h2>
                ...
                <div class="mt-10 flex flex-col items-center">
                    ...
                    <div class="mt-4 flex items-center gap-4">
                        <span class="font-flatline font-semibold text-3xl text-dark-text/40 line-through italic">$40,000</span>
                        <span class="font-flatline font-semibold text-5xl md:text-6xl text-gold-section italic">$25,000</span>
                    </div>
                    <p class="mt-4 font-garet text-base text-navy">Keynote, positioning, and leadership refinement</p>
                </div>
