...
$default_text = <<<HTML
<p>You&rsquo;ve built real success but internally:</p>
<ul>
  <li>communication becomes inconsistent</li>
  <li>leadership depends too heavily on you</li>
  <li>trust weakens as teams scale</li>
  <li>culture becomes harder to sustain</li>
</ul>
<p>You don&rsquo;t need more management.</p>
<p>You need a leadership framework people can actually operate through.</p>
HTML;
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-center gap-8">
            ...
            <div class="w-full lg:flex-1">
                ...
                <?php else: ?>
                    <img src="<?= esc_url(get_template_directory_uri()) ?>/assets/images/build-my-team1.webp" alt="Joanna Horton McPherson" class="w-full h-[450px] object-cover rounded-[10px]">
                <?php endif; ?>
            </div>
        </div>
    </div>
