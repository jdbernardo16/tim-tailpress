...
/**
 * Master My Message Page - Hero Section template part.
 *
 * @package TailPress
 */

$heading = get_field('section_hero_heading') ?: 'Become Known<br><em class="text-gold italic">for Something Specific.</em>';
$subtitle = get_field('section_hero_subtitle') ?: 'Master My Message is Joanna&rsquo;s advanced authority-positioning experience designed for leaders ready to refine, elevate, and scale the message people remember them for. This is where your message becomes distinct, repeatable, and impossible to confuse with anyone else&rsquo;s.';
