    ...
    <div class="relative w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
        <div class="flex flex-col items-center text-center">
            ...
            <h1 class="mt-6 font-flatline font-semibold text-4xl md:text-5xl lg:text-[64px] text-white leading-[1.1]">
                Stories People<br>Now Carry <em class="text-gold italic">Differently</em>.
            </h1>

            <!-- Description -->
            <p class="mt-6 font-garet text-lg text-white leading-[27px] max-w-[600px]">
                Conversations, retreats, and transformational experiences that helped leaders reconnect with their voice, clarity, confidence, and influence.
            </p>
        </div>
    </div>
</section>
