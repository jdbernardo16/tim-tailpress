...
/**
 * Be Remembered Page - Registration Form Section template part.
 *
 * @package TailPress
 */

$heading = get_field('section_form_heading') ?: '<em class="text-gold italic">Begin</em> the Conversation.';
$text = get_field('section_form_text') ?: '<p>A private conversation to explore your legacy, succession, voice, and the long-term impact you want your work to carry forward.</p>';
...
<section class="relative px-4 sm:px-6 lg:px-8 pb-24" id="register">
    <div class="relative max-w-[1360px] mx-auto bg-navy rounded-[20px] overflow-hidden">
        ...
        <!-- BE REMEMBERED watermark tag at top -->
            ...
            <div class="max-w-[760px] mx-auto text-center">
                ...
                <form class="mt-10 text-left" action="https://services.leadconnectorhq.com/hooks/txFvEqJbQlKriCxJl8w3/webhook-trigger/a3e3e65a-e7d2-4aa4-b34d-bd02d0265e35" method="POST">
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block font-garet text-sm text-white mb-2" for="legacy">What kind of legacy do you want your work, leadership, and influence to leave behind?<span class="text-gold">*</span></label>
                            <textarea class="w-full px-4 py-3 rounded-[10px] bg-white border border-warm-beige font-garet text-base text-dark-text placeholder:text-dark-text/50 outline-none focus:border-gold resize-none" rows="5" id="legacy" name="legacy" placeholder="Share the legacy you want to build..." required></textarea>
                        </div>

                        <div>
                            <label class="block font-garet text-sm text-white mb-2" for="continuity">What would need to be in place for your impact to continue long after you step back?</label>
                            <textarea class="w-full px-4 py-3 rounded-[10px] bg-white border border-warm-beige font-garet text-base text-dark-text placeholder:text-dark-text/50 outline-none focus:border-gold resize-none" rows="5" id="continuity" name="continuity" placeholder="Share what continuity would look like..."></textarea>
                        </div>
