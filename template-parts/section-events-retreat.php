        ...
        <div class="flex flex-col lg:flex-row items-center gap-4">
            ...
            <div class="w-7/12 max-w-xl">
                ...
                <div class="aspect-[636/281] w-full rounded-xl overflow-hidden shadow-lg mt-6">
                    <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/events-frame2-img2.png" alt="Laptop and books on a table" class="w-full h-full object-cover">
                </div>
            ...
            <div class="w-5/12 relative  max-w-lg lg:max-w-xl">
                <div class="relative">
                    ...
                    <div class="rounded-xl overflow-hidden shadow-lg aspect-[448/566] w-full">
                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/event-frame2-img1.png" alt="Joanna on a couch in red pants" class="w-full h-full object-cover">
                    </div>
