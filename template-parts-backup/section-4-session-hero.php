...
<section class="relative bg-navy overflow-hidden">
    ...
    <div class="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 flex flex-col items-center text-center">
        ...
        <h1 class="mt-8 font-flatline font-semibold text-5xl md:text-6xl lg:text-[64px] text-white leading-[1.1]">
            Build the Message<br><em class="text-gold italic">From the Inside Out.</em>
        </h1>

        <!-- Description -->
        <div class="mt-6 font-garet text-lg text-white leading-[1.6] max-w-[600px] space-y-3">
            <p>The 4-Session Training Package is a private experience for leaders ready to uncover, refine, and clearly articulate the message behind their work.</p>
            <p>Together, you move beyond explaining and begin building a message that feels true, clear, and aligned.</p>
        </div>
    </div>
</section>
