...
/**
 * Build My Team Page - "What You Build" Section template part.
 *
 * @package TailPress
 */

$bullets = array(
    'A leadership framework rooted in trust and clarity',
    'A scalable mentorship structure',
    'A repeatable leadership philosophy',
    'A culture people can lead through consistently',
    'Aligned communication across the organization',
    'A leadership system that doesn\'t depend on you alone',
);
?>
<section class="bg-canvas py-12 lg:py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative bg-navy rounded-3xl overflow-hidden">
            ...
            <!-- Build My Team wordmark behind heading -->
            <div class="absolute top-6 left-0 right-0 flex justify-center pointer-events-none">
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/build-my-team-text.webp" alt="" aria-hidden="true" class="h-20 md:h-24 opacity-20 object-contain">
            </div>
            ...
            <div class="relative px-6 py-20 md:px-12 md:py-24 lg:px-20 lg:py-28 flex flex-col items-center text-center">
                ...
                <p class="mt-10 font-garet text-lg text-white leading-[1.5] max-w-[600px]">
                    You create psychological safety and trust inside your team and a repeatable system others can lead through.
                </p>
            </div>
        </div>
    </div>
