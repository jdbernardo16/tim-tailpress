...
/**
 * Build My Team Page - "Leadership That Scales Beyond You" Section template part.
 *
 * @package TailPress
 */
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div class="w-full lg:w-1/2 order-2 lg:order-1">
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/build-my-team2.webp" alt="Joanna connecting with leadership teams" class="w-full h-[560px] object-cover rounded-xl">
            </div>

            <!-- Text Content -->
            <div class="w-full lg:w-1/2 order-1 lg:order-2">
                <h2 class="font-flatline font-medium text-4xl md:text-5xl lg:text-[56px] text-navy leading-[1.1]">
                    Leadership That Scales <em class="text-gold italic">Beyond You.</em>
                </h2>

                <p class="mt-6 font-garet text-lg text-dark-text leading-[1.5] max-w-[460px]">
                    Joanna works privately with founders, executives, and leadership teams to refine communication, alignment, emotional trust, and long-term organizational influence.
                </p>
