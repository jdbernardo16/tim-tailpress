...
<section class="relative bg-navy overflow-hidden">
    ...
    <div class="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 flex flex-col items-center text-center">
        ...
        <h1 class="mt-8 font-flatline font-semibold text-5xl md:text-6xl lg:text-[64px] text-white leading-[1.1]">
            Become Known<br><em class="text-gold italic">for Something Specific.</em>
        </h1>

        <!-- Description -->
        <div class="mt-6 font-garet text-lg text-white leading-[1.6] max-w-[600px] space-y-3">
            <p>Master My Message is Joanna&rsquo;s advanced authority-positioning experience designed for leaders ready to refine, elevate, and scale the message people remember them for.</p>
            <p>This is where your message becomes distinct, repeatable, and impossible to confuse with anyone else&rsquo;s.</p>
        </div>
    </div>
</section>
