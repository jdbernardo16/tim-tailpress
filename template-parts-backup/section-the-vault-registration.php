...
/**
 * The Vault Page - Registration Section template part.
 *
 * @package TailPress
 */
?>
<section class="relative px-4 sm:px-6 lg:px-8 pb-24" id="register">
    <div class="relative max-w-[1360px] mx-auto bg-navy rounded-[20px] overflow-hidden">
        ...
        <!-- THE VAULT watermark tag at top -->
            ...
            <div class="max-w-[760px] mx-auto text-center">
                ...
                <form class="mt-10 text-left" action="https://services.leadconnectorhq.com/hooks/txFvEqJbQlKriCxJl8w3/webhook-trigger/a3e3e65a-e7d2-4aa4-b34d-bd02d0265e35" method="POST">
                    <div class="space-y-4">
                        ...
                        <div>
                            <label class="block font-garet text-sm text-white mb-2" for="description">What best describes you?<span class="text-gold">*</span></label>
                            <div class="relative">
                                <select class="w-full px-4 py-3 rounded-[10px] bg-white border border-warm-beige font-garet text-base text-dark-text outline-none focus:border-gold appearance-none" id="description" name="description" required>
                                ...
                                <svg class="absolute right-4 top-1/2 -translate-y-1/2 w-3 h-2 pointer-events-none" viewBox="0 0 12 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 1.5L6 6.5L11 1.5" stroke="#0f203d" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                            </div>
                        </div>

                        <div>
                            <label class="block font-garet text-sm text-white mb-2" for="challenge">What is your biggest speaking challenge right now?</label>
                            <textarea class="w-full px-4 py-3 rounded-[10px] bg-white border border-warm-beige font-garet text-base text-dark-text placeholder:text-dark-text/50 outline-none focus:border-gold resize-none" rows="5" id="challenge" name="challenge" placeholder="Share what feels most challenging about speaking, presenting, or finding your voice..."></textarea>
                        </div>
