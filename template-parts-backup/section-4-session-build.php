...
/**
 * 4-Session Training Package Page - "What You Leave With" Section template part.
 *
 * @package TailPress
 */
...
$bullets = array(
    ...
    'A clearer understanding of what shaped your work',
    'Your deeper why',
    'A message you can actually say out loud',
    'Greater clarity around your leadership and differentiator',
);
?>
<section class="bg-canvas py-12 lg:py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="relative bg-navy rounded-3xl overflow-hidden">
            ...
            <!-- 4-SESSION TRAINING wordmark behind heading -->
            <div class="absolute top-6 left-0 right-0 flex justify-center pointer-events-none">
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/4-session-text.webp" alt="" aria-hidden="true" class="h-20 md:h-24 opacity-20 object-contain">
            </div>
            ...
            <div class="relative px-6 py-20 md:px-12 md:py-24 lg:px-20 lg:py-28 flex flex-col items-center text-center">
                ...
                <h2 class="font-flatline font-semibold text-4xl md:text-5xl lg:text-[56px] text-white leading-[1.1]">
                    What You <em class="text-gold italic">Leave</em> With
                </h2>
                ...
                <p class="mt-10 font-garet text-lg text-white leading-[1.5] max-w-[600px]">
                    This is where the message stops feeling scattered and starts feeling aligned.
                </p>
            </div>
        </div>
    </div>
