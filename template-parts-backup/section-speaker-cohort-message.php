        ...
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div class="w-full lg:w-1/2">
                <h2 class="font-flatline font-medium text-4xl md:text-5xl lg:text-[56px] text-navy leading-[1.1]">
                    You Know Your Work. But Your Message Still <em class="text-gold italic">Isn't Landing.</em>
                </h2>
            ...
            <!-- Image -->
            <div class="w-full lg:w-1/2">
                <img src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/move-the-room1.webp" alt="Joanna Horton McPherson" class="w-full h-[450px] object-cover rounded-xl">
            </div>
        </div>
    </div>
</section>
